export const authoringComponentsPrompt = `
...
To publish a component on NPM, check out "[PUBLISHING.md](https://github.com/get-convex/templates/blob/main/template-component/PUBLISHING.md)" in the template repository.
